...
func withExampleID(id int64) exampleOption {
...
func (m *ExampleMutation) SetID(id int64) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *ExampleMutation) ID() (id int64, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
func (m *ExampleMutation) IDs(ctx context.Context) ([]int64, error) {
	switch {
