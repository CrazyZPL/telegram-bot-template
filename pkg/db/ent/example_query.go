...
import (
	...
	"github.com/telegram-bot-template/pkg/db/ent/predicate"
)
...
func (eq *ExampleQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (eq *ExampleQuery) FirstIDX(ctx context.Context) int64 {
...
func (eq *ExampleQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (eq *ExampleQuery) OnlyIDX(ctx context.Context) int64 {
...
func (eq *ExampleQuery) IDs(ctx context.Context) ([]int64, error) {
	var ids []int64
...
func (eq *ExampleQuery) IDsX(ctx context.Context) []int64 {
	ids, err := eq.IDs(ctx)
	if err != nil {
		panic(err)
	}
