...
import (
	...
	"github.com/telegram-bot-template/pkg/db/ent/migrate"
...
func (c *ExampleClient) UpdateOneID(id int64) *ExampleUpdateOne {
...
func (c *ExampleClient) DeleteOneID(id int64) *ExampleDeleteOne {
...
func (c *ExampleClient) Get(ctx context.Context, id int64) (*Example, error) {
	return c.Query().Where(example.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *ExampleClient) GetX(ctx context.Context, id int64) *Example {
